            ...
            <div className="w-full px-6 md:px-12 grid grid-cols-1 md:grid-cols-4 gap-12">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex flex-col gap-2 text-sm">
                        <Link href="https://github.com/duball97/OpenTxs" target="_blank" className="hover:text-pink-400 transition-colors flex items-center gap-2">
                            <Github className="w-4 h-4" /> Source Code
                        </Link>
                        <Link href="https://github.com/duball97/OpenTxs/blob/main/LICENSE" target="_blank" className="hover:text-pink-400 transition-colors">
                            MIT License
                        </Link>
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex flex-col gap-2 text-sm">
                        <Link href="https://x.com/duball97" target="_blank" className="hover:text-pink-400 transition-colors flex items-center gap-2">
